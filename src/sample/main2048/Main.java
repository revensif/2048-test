package sample.main2048;

import sample.main2048.game.Game;
import sample.main2048.input.Keyboard;
...
public class Main extends Canvas implements Runnable {
    ...
    public void run() {
        ...
        while (running) {
            ...
            updateToPerform += (currentTimeInNanoSeconds - lastTimeNanoSeconds) / nanoSecondsPerUpdate;
